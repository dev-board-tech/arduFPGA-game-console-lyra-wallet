...
#define KBD_U_DIR					DDRD
#define KBD_U_PORT					PORTD
#define KBD_U_IN					PIND
#define KBD_U_PIN					(1<<5)

#define KBD_D_DIR					DDRD
#define KBD_D_PORT					PORTD
#define KBD_D_IN					PIND
#define KBD_D_PIN					(1<<4)

#define KBD_B_DIR					DDRD
#define KBD_B_PORT					PORTD
#define KBD_B_IN					PIND
#define KBD_B_PIN					(1<<7)

#define KBD_A_DIR					DDRD
#define KBD_A_PORT					PORTD
#define KBD_A_IN					PIND
#define KBD_A_PIN					(1<<6)

/*#define KBD_INT_DIR					DDRD
#define KBD_INT_PORT				PORTD
#define KBD_INT_IN					PIND
#define KBD_INT_PIN					(1<<4)*/

#define KBD_L_DIR					DDRD
#define KBD_L_PORT					PORTD
#define KBD_L_IN					PIND
#define KBD_L_PIN					(1<<3)

#define KBD_R_DIR					DDRD
#define KBD_R_PORT					PORTD
#define KBD_R_IN					PIND
#define KBD_R_PIN					(1<<2)
...
#define SPI_CS_1_DIR				DDRC
#define SPI_CS_1_PORT				PORTC
#define SPI_CS_1_PIN				(1<<2)
...
#define SPI_CS_7_DIR				DDRB
#define SPI_CS_7_PORT				PORTB
#define SPI_CS_7_PIN				(1<<2)
...
#define DISPLAY_RST_DIR				DDRC
#define DISPLAY_RST_PORT			PORTC
#define DISPLAY_RST_PIN				(1<<0)

#define DISPLAY_DC_DIR				DDRC
#define DISPLAY_DC_PORT				PORTC
#define DISPLAY_DC_PIN				(1<<1)
